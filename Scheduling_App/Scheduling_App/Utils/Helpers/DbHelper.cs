...
public class DbHelper : IDisposable
{
    ...
    public DbHelper(string connectionstring, Providers provider)
    {
        ...
        switch (provider)
        {
            ...
            case Providers.ConfigDefined:
                string providername = ConfigurationManager.ConnectionStrings["MyModel"].ProviderName;
                switch (providername)
                {
    ...
    public DbHelper(Providers provider)
        : this(ConfigurationManager.ConnectionStrings["MyModel"].ConnectionString, provider)
    {
    }

    public DbHelper(string connectionstring) : this(connectionstring, Providers.SqlServer)
    {
    }

    public DbHelper()
        : this(ConfigurationManager.ConnectionStrings["MyModel"].ConnectionString, Providers.ConfigDefined)
    {
    }
